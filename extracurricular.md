...
<article class="page wide extracurricular-page">
  ...
  <div class="center-image-text-wrap organic-center-wrap extra-center-image-wrap balanced-reading-wrap v81-through-wrap">
    ...
    <div class="prose center-wrap-text center-wrap-text-left">      <p>My academic life also includes service, outreach, and community building. I have been involved in graduate student organization, departmental representation, public educational work, and workshop programming connected to Middle Eastern and North African Studies.</p>
    ...
    <div class="prose center-wrap-text center-wrap-text-right">      <p>In addition to departmental service, I have been involved in public outreach through the Center for Middle Eastern Studies. As a CMES Outreach Scholar, I participated in public facing educational work and gave outreach presentations on topics related to the Middle East, Turkey, Islam, and Ottoman history. My CMES profile is available here: <a href="https://cmes.arizona.edu/people/muhammet-topal" target="_blank" rel="noopener">CMES Outreach Scholar profile</a>.</p>

      <span class="wrap-shape wrap-shape-right" aria-hidden="true"></span>

      <p>I have also contributed to graduate student colloquia and workshop programming. These activities matter to me because they create intellectual community outside the formal classroom. They give students the chance to test ideas, receive feedback, and build conversations across fields, languages, and regional specializations.</p>
    </div>
  </div>
