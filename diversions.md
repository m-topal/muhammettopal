...
<article class="page wide">
  ...
  <div class="photo-text">
    <img src="{{ '/assets/img/grand-canyon-home.jpg' | relative_url }}" alt="Muhammet Topal at the Grand Canyon">
    <div class="prose">
      <h2>Beyond academia</h2>
      <p>Moving from Istanbul and Paris to Arizona changed my sense of landscape. Coming from dense urban worlds into the desert, mountains, canyons, and open horizons of the American Southwest made hiking, climbing, and outdoor life part of how I think and live. This image is from my first camping trip at the Grand Canyon.</p>
