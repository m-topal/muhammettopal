...
<article class="page wide">
  ...
  <div class="experience-summary">
    <div><strong>5</strong><span>Syllabi designed</span></div>
    <div><strong>3</strong><span>Full semester courses taught</span></div>
    <div><strong>4</strong><span>Semesters teaching Political Islam</span></div>
    <div><strong>2</strong><span>Sample lectures delivered</span></div>
  </div>
  ...
  <div class="experience-grid">
    <section class="experience-card">
      ...
      <p class="meta-line">HIST, MENA, POL 385 · University of Arizona · Four semesters</p>
    ...
    <section class="experience-card">
      <h2>Course Design</h2>
      <p>I have designed five syllabi and taught three full semester courses as Instructor of Record. One of these courses, Introduction to Political Islam, I taught across four semesters. I also delivered sample lectures for two additional courses. This experience trained me to design courses around clear learning objectives, weekly themes, reading arcs, classroom activities, and assignments that build over time.</p>
    ...
    <section class="experience-card">
      <h2>Graduate Certificate in College Teaching</h2>
      <p>At the University of Arizona, I completed the Graduate Certificate in College Teaching. The coursework included Learner Centered Teaching, Technology in Teaching, Teaching as Research, and College Teaching Practice.</p>
      <p>This training strengthened my approach to backward design, transparent assessment, inclusive teaching, student participation, digital tools, and the scholarship of teaching and learning.</p>
    </section>

    <section class="experience-card">
      <h2>Earlier Teaching in Istanbul</h2>
      <p class="meta-line">Eylül Academy, Istanbul · 2015 to 2021</p>
